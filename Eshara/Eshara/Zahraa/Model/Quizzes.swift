...
let familyQ1 = Question(imgName: "أب", questionText: "لمن تُستخدم هذه الإشارة؟", options: ["للأم", "للأخ", "للأب", "للعم"], correctAns: 2, wrongAns: -1, isAnswered: false)
let familyQ2 = Question(imgName: "توأم", questionText: "ماذا تعني هذه الإشارة؟", options: ["طفل", "توأم", "حفيد", "أسرة"], correctAns: 1, wrongAns: -1, isAnswered: false)
...
let familyQ5 = Question(imgName: "أسرة", questionText: "ما معنى هذه الإشارة؟", options: ["تجمع", "أسرة", "طائفة", "مجموعة"], correctAns: 1, wrongAns: -1, isAnswered: false)
...
let houseQ1 = Question(imgName: "ديوانية", questionText: "إلى أي المرافق ترمز هذه الإشارة؟", options: ["الديوانية", "غرفة النوم", "المطبخ", "الملحق"], correctAns: 0, wrongAns: -1, isAnswered: false)
...
let animalsQ5 = Question(imgName: "طائر", questionText: "إلى أي الحيوانات ترمز هذه الإشارة؟", options: ["الزواحف", "الحشرات", "الثدييات", "الطيور"], correctAns: 3, wrongAns: -1, isAnswered: false)
